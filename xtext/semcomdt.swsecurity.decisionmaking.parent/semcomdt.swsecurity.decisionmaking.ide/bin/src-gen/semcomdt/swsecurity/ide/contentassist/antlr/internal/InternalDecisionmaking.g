...
import semcomdt.swsecurity.services.DecisionmakingGrammarAccess;
...
// Entry rule entryRuleSolutionPreference
entryRuleSolutionPreference
:
{ before(grammarAccess.getSolutionPreferenceRule()); }
	 ruleSolutionPreference
{ after(grammarAccess.getSolutionPreferenceRule()); } 
	 EOF 
;

// Rule SolutionPreference
ruleSolutionPreference 
	@init {
		int stackSize = keepStackSize();
	}
	:
	(
		{ before(grammarAccess.getSolutionPreferenceAccess().getGroup()); }
		(rule__SolutionPreference__Group__0)
		{ after(grammarAccess.getSolutionPreferenceAccess().getGroup()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getDesignTimeAccess().getDecisionSupportKeyword_2()); }
	'DecisionSupport'
	{ after(grammarAccess.getDesignTimeAccess().getDecisionSupportKeyword_2()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getDesignTimeAccess().getNameAssignment_3()); }
	(rule__DesignTime__NameAssignment_3)
	{ after(grammarAccess.getDesignTimeAccess().getNameAssignment_3()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__DesignTime__Group__4__Impl
	rule__DesignTime__Group__5
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getDesignTimeAccess().getDecidesForKeyword_4()); }
	'decidesFor'
	{ after(grammarAccess.getDesignTimeAccess().getDecidesForKeyword_4()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__DesignTime__Group__5__Impl
	rule__DesignTime__Group__6
;
finally {
	restoreStackSize(stackSize);
}
...
(
	(
		{ before(grammarAccess.getDesignTimeAccess().getMakedecisionforAssignment_5()); }
		(rule__DesignTime__MakedecisionforAssignment_5)
		{ after(grammarAccess.getDesignTimeAccess().getMakedecisionforAssignment_5()); }
	)
	(
		{ before(grammarAccess.getDesignTimeAccess().getMakedecisionforAssignment_5()); }
		(rule__DesignTime__MakedecisionforAssignment_5)*
...
:
	rule__DesignTime__Group__6__Impl
	rule__DesignTime__Group__7
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getDesignTimeAccess().getLeftCurlyBracketKeyword_6()); }
	'{'
	{ after(grammarAccess.getDesignTimeAccess().getLeftCurlyBracketKeyword_6()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__DesignTime__Group__7__Impl
	rule__DesignTime__Group__8
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getDesignTimeAccess().getStratAssignment_7()); }
	(rule__DesignTime__StratAssignment_7)*
	{ after(grammarAccess.getDesignTimeAccess().getStratAssignment_7()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__DesignTime__Group__8__Impl
	rule__DesignTime__Group__9
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getDesignTimeAccess().getRightCurlyBracketKeyword_8()); }
	'}'
	{ after(grammarAccess.getDesignTimeAccess().getRightCurlyBracketKeyword_8()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__DesignTime__Group__9__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getDesignTimeAccess().getRightCurlyBracketKeyword_9()); }
	'}'
	{ after(grammarAccess.getDesignTimeAccess().getRightCurlyBracketKeyword_9()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getRunTimeAccess().getLeftCurlyBracketKeyword_1()); }
	'{'
	{ after(grammarAccess.getRunTimeAccess().getLeftCurlyBracketKeyword_1()); }
)
;
finally {
	restoreStackSize(stackSize);
...
(
	(
		{ before(grammarAccess.getRunTimeAccess().getPreferencespecificationAssignment_2()); }
		(rule__RunTime__PreferencespecificationAssignment_2)
		{ after(grammarAccess.getRunTimeAccess().getPreferencespecificationAssignment_2()); }
	)
	(
		{ before(grammarAccess.getRunTimeAccess().getPreferencespecificationAssignment_2()); }
		(rule__RunTime__PreferencespecificationAssignment_2)*
...
:
(
	{ before(grammarAccess.getRunTimeAccess().getRightCurlyBracketKeyword_3()); }
	'}'
	{ after(grammarAccess.getRunTimeAccess().getRightCurlyBracketKeyword_3()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__SolutionPreference__Group__0__Impl
	rule__SolutionPreference__Group__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getSolutionPreferenceAccess().getActorAssignment_0()); }
	(rule__SolutionPreference__ActorAssignment_0)
	{ after(grammarAccess.getSolutionPreferenceAccess().getActorAssignment_0()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__SolutionPreference__Group__1__Impl
	rule__SolutionPreference__Group__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getSolutionPreferenceAccess().getSelectedKeyword_1()); }
	'selected'
	{ after(grammarAccess.getSolutionPreferenceAccess().getSelectedKeyword_1()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__SolutionPreference__Group__2__Impl
	rule__SolutionPreference__Group__3
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getSolutionPreferenceAccess().getLeftParenthesisKeyword_2()); }
	'('
	{ after(grammarAccess.getSolutionPreferenceAccess().getLeftParenthesisKeyword_2()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__SolutionPreference__Group__3__Impl
	rule__SolutionPreference__Group__4
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getSolutionPreferenceAccess().getPreferenceAssignment_3()); }
	(rule__SolutionPreference__PreferenceAssignment_3)*
	{ after(grammarAccess.getSolutionPreferenceAccess().getPreferenceAssignment_3()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__SolutionPreference__Group__4__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getSolutionPreferenceAccess().getRightParenthesisKeyword_4()); }
	')'
	{ after(grammarAccess.getSolutionPreferenceAccess().getRightParenthesisKeyword_4()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getPreferenceAccess().getValueAssignment_0()); }
	(rule__Preference__ValueAssignment_0)
	{ after(grammarAccess.getPreferenceAccess().getValueAssignment_0()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getPreferenceAccess().getForKeyword_1()); }
	'for'
	{ after(grammarAccess.getPreferenceAccess().getForKeyword_1()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getPreferenceAccess().getAlternativeAssignment_2()); }
	(rule__Preference__AlternativeAssignment_2)
	{ after(grammarAccess.getPreferenceAccess().getAlternativeAssignment_2()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getDesignTimeAccess().getNameIDTerminalRuleCall_3_0()); }
		RULE_ID
		{ after(grammarAccess.getDesignTimeAccess().getNameIDTerminalRuleCall_3_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getDesignTimeAccess().getMakedecisionforCategoryCrossReference_5_0()); }
		(
			{ before(grammarAccess.getDesignTimeAccess().getMakedecisionforCategoryQualifiedNameParserRuleCall_5_0_1()); }
			ruleQualifiedName
			{ after(grammarAccess.getDesignTimeAccess().getMakedecisionforCategoryQualifiedNameParserRuleCall_5_0_1()); }
		)
		{ after(grammarAccess.getDesignTimeAccess().getMakedecisionforCategoryCrossReference_5_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getDesignTimeAccess().getStratStratParserRuleCall_7_0()); }
		ruleStrat
		{ after(grammarAccess.getDesignTimeAccess().getStratStratParserRuleCall_7_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getRunTimeAccess().getPreferencespecificationSolutionPreferenceParserRuleCall_2_0()); }
		ruleSolutionPreference
		{ after(grammarAccess.getRunTimeAccess().getPreferencespecificationSolutionPreferenceParserRuleCall_2_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getSolutionPreferenceAccess().getActorActorCrossReference_0_0()); }
		(
			{ before(grammarAccess.getSolutionPreferenceAccess().getActorActorIDTerminalRuleCall_0_0_1()); }
			RULE_ID
			{ after(grammarAccess.getSolutionPreferenceAccess().getActorActorIDTerminalRuleCall_0_0_1()); }
		)
		{ after(grammarAccess.getSolutionPreferenceAccess().getActorActorCrossReference_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getSolutionPreferenceAccess().getPreferencePreferenceParserRuleCall_3_0()); }
		rulePreference
		{ after(grammarAccess.getSolutionPreferenceAccess().getPreferencePreferenceParserRuleCall_3_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getPreferenceAccess().getValueINTTerminalRuleCall_0_0()); }
		RULE_INT
		{ after(grammarAccess.getPreferenceAccess().getValueINTTerminalRuleCall_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getPreferenceAccess().getAlternativeAlternativeCrossReference_2_0()); }
		(
			{ before(grammarAccess.getPreferenceAccess().getAlternativeAlternativeQualifiedNameParserRuleCall_2_0_1()); }
			ruleQualifiedName
			{ after(grammarAccess.getPreferenceAccess().getAlternativeAlternativeQualifiedNameParserRuleCall_2_0_1()); }
		)
		{ after(grammarAccess.getPreferenceAccess().getAlternativeAlternativeCrossReference_2_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
